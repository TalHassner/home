...
<table>
  ...
  <tr>
    <td>(a) A query photo <br/>(from the [LFW](http://vis-www.cs.umass.edu/lfw/) collection)</td>
    <td>(b) [Facial feature detection](http://www.ics.uci.edu/~xzhu/face/) <br/>on the query and the rendered reference in frontal pose</td>
    <td>(c) Output, pose adjusted reference,<br/> along with depth-map</td>
  </tr>  
</table>
