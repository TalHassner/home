...
excerpt: '[<font color="SkyBlue"><i>Download paper</i></font>](https://osnathassner.github.io/talhassner/projects/MIP/MIP_eccv12.pdf)'
date: 2012-10-01
...
------
MATLAB code for computing the Motion Interchange Patterns (MIP) video descriptor is now available for [download here](https://osnathassner.github.io/talhassner/projects/MIP/MIPcode.zip). Please see the [ReadMe.txt](https://osnathassner.github.io/talhassner/projects/MIP/ReadMe.txt) for information on how to install and run the code.

If you use this code in your own work, please cite [our paper](https://osnathassner.github.io/talhassner/projects/MIP/BibTeX.txt).

<br/>**Copyright and disclaimer:**
